...
class MVTecDataset(Dataset):
    def __init__(self, root_path='../data', class_name='bottle', is_train=True,
        ...
        self.mvtec_folder_path = '/home/wangyizhuo/Documents/DATA_SETS/dataset_anomaly_detection' #os.path.join(root_path, 'mvtec_anomaly_detection')
        ...
        # set transforms
        self.transform_x = T.Compose([T.Resize((224,224), Image.ANTIALIAS),
                                      #T.CenterCrop(cropsize),
                                      T.ToTensor(),
                                      T.Normalize(mean=[0.485, 0.456, 0.406],
                                                  std=[0.229, 0.224, 0.225])])
        self.transform_mask = T.Compose([T.Resize((224,224), Image.NEAREST),
                                         #T.CenterCrop(cropsize),
                                         T.ToTensor()])
