...
def parse_arguments(data_type,pro):
    ...
    parser.add_argument(
        '--dataset_base_dir',
        default='/home/wangyizhuo/Documents/DATA_SETS/mvtec_loco_anomaly_detection/',
        help='Path to the directory that contains the dataset images of the'
             ' MVTec LOCO AD dataset.')

    parser.add_argument(
        '--anomaly_maps_dir',
        default='/home/wangyizhuo/Documents/PY_CODE/lunwen/SPADE-pytorch-master/src/log_metris/',
        #required=True,
...
def EVAL_ME(data_type='d',pro=6):
    args = parse_arguments(data_type, pro)
    ...
    print('mean: ',localization_results['auc_spro']['mean'])
    print('logical_anomalies: ',localization_results['auc_spro']['logical_anomalies'])
    print('structural_anomalies: ',localization_results['auc_spro']['structural_anomalies'])
